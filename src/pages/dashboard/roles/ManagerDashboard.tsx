        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-600 mt-1">Vue consolidée et analyse de performance</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="text-sm font-semibold text-slate-700">Période Actuelle</h4>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                                    <span className="text-sm text-slate-700">CA Total</span>
                                    <span className="font-semibold text-slate-900">{current.financial.totalRevenue.toLocaleString()} GNF</span>
                                </div>
                                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                                    <span className="text-sm text-slate-700">Bénéfice Net</span>
                                    <span className="font-semibold text-slate-900">{current.financial.netProfit.toLocaleString()} GNF</span>
                                </div>
                                <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                                    <span className="text-sm text-slate-700">Nombre de ventes</span>
                                    <span className="font-semibold text-slate-900">{current.sales.totalSales}</span>
                                </div>
                                <div className="flex items-center justify-between p-3 bg-cyan-50 rounded-lg">
                                    <span className="text-sm text-slate-700">Panier moyen</span>
                                    <span className="font-semibold text-slate-900">{current.sales.averageSaleAmount.toLocaleString()} GNF</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="text-sm font-semibold text-slate-700">Période Précédente</h4>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                    <span className="text-sm text-slate-600">CA Total</span>
                                    <div className="text-right">
                                        <span className="font-semibold text-slate-700">{performanceData.previous.financial.totalRevenue.toLocaleString()} GNF</span>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                    <span className="text-sm text-slate-600">Bénéfice Net</span>
                                    <div className="text-right">
                                        <span className="font-semibold text-slate-700">{performanceData.previous.financial.netProfit.toLocaleString()} GNF</span>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                    <span className="text-sm text-slate-600">Nombre de ventes</span>
                                    <div className="text-right">
                                        <span className="font-semibold text-slate-700">{performanceData.previous.sales.totalSales}</span>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                    ...
                                    <div className="text-right">
                                        <span className="font-semibold text-slate-700">{performanceData.previous.sales.averageSaleAmount.toLocaleString()} GNF</span>
                            ...
                            {overviewData.salesByStore.map((store: any, index: number) => (
                                <div key={store.store.id} className="flex items-center justify-between p-3 border border-slate-200 rounded-lg hover:border-indigo-300 transition">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-slate-800">{store.store.name}</p>
                                            <p className="text-xs text-slate-500">{store.store.city}</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="font-bold text-slate-900">{store.totalRevenue.toLocaleString()} GNF</p>
                        ...
                        <div className="space-y-3">
                            {overviewData.topProducts.slice(0, 5).map((item: any, index: number) => (
                                <div key={item.product.id} className="flex items-start gap-3">
                                    <span className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${index === 0 ? 'bg-yellow-100 text-yellow-700' :
