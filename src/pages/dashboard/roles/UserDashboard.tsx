        ...
        <div className="space-y-6">
                ...
                <div className={theme.card.base}>
                    ...
                    <div className={theme.card.body}>
                        <div className="space-y-4">
                            ...
                            <button className={`w-full ${theme.button.base} ${theme.button.primary}`}>
                                Modifier mon profil
                            </button>
                        </div>
                    </div>
                    ...
                    <div className={theme.card.body}>
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-slate-800">Mot de passe sécurisé</p>
                                    <p className="text-sm text-slate-500 mt-1">Votre mot de passe respecte les critères de sécurité</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-slate-800">Email vérifié</p>
                                    <p className="text-sm text-slate-500 mt-1">{user.email}</p>
                                </div>
                            </div>

                            <button className={`w-full ${theme.button.base} ${theme.button.secondary} mt-4`}>
            ...
            <div className={theme.card.base}>
                ...
                <div className={theme.card.body}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <button className={`${theme.button.base} ${theme.button.secondary} py-4 flex-col`}>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h4 className="font-bold text-slate-800 mb-2">Accès Limité</h4>
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-center gap-2 text-slate-400">
                                ...
                                <span>Gestion des ventes (nécessite le rôle CASHIER)</span>
                            </div>
                            <div className="flex items-center gap-2 text-slate-400">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                </svg>
                                <span>Gestion du stock (nécessite le rôle STORE_MANAGER)</span>
                            </div>
                            <div className="flex items-center gap-2 text-slate-400">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                </svg>
                                <span>Accès aux rapports (nécessite le rôle MANAGER)</span>
                            </div>
                        </div>
                        <button className={`mt-4 ${theme.button.base} ${theme.button.primary} text-sm`}>
            ...
            <div className={theme.card.base}>
                ...
                <div className={theme.card.body}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h5 className="font-semibold text-slate-800 mb-3">Documentation</h5>
                            <ul className="space-y-2">
                                <li>
                                    <a href="#" className="text-sm text-indigo-600 hover:text-indigo-800 flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h5 className="font-semibold text-slate-800 mb-3">Support</h5>
                            <ul className="space-y-2">
                                <li>
                                    <a href="#" className="text-sm text-indigo-600 hover:text-indigo-800 flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
