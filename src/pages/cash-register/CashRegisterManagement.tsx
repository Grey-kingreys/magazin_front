        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-600 mt-1">Ouverture, fermeture et suivi des sessions de caisse</p>
                </div>
                <button
            ...
            {stats && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white rounded-xl border border-slate-200 p-4">
                        ...
                        <p className="text-3xl font-bold text-slate-900">{stats.totalCashRegisters}</p>
                    </div>
                    <div className="bg-green-50 rounded-xl border border-green-200 p-4">
                        <p className="text-sm text-green-700">Ouvertes</p>
                        <p className="text-3xl font-bold text-green-900">{stats.openCashRegisters}</p>
                    </div>
                    <div className="bg-blue-50 rounded-xl border border-blue-200 p-4">
                        <p className="text-sm text-blue-700">Fermées</p>
                        <p className="text-3xl font-bold text-blue-900">{stats.closedCashRegisters}</p>
                    </div>
                    <div className="bg-purple-50 rounded-xl border border-purple-200 p-4">
                        <p className="text-sm text-purple-700">Chiffre d'affaires</p>
                        <p className="text-2xl font-bold text-purple-900">{stats.totalRevenue.toLocaleString('fr-FR')} GNF</p>
                    </div>
                </div>
            )}
